...
With many examples on common PHP tools, discover the Plugin features :

1. How to use the `binary-directory` option and/or `XDG_BIN_HOME` env var with [Easy-Coding-Standard](ecs.md)
